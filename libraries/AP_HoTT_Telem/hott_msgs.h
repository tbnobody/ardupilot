...
#define TEXT_MODE_START_BYTE   0x7b
#define TEXT_MODE_STOP_BYTE    0x7d

#define BINARY_MODE_START_BYTE 0x7c
#define BINARY_MODE_STOP_BYTE  0x7d

//Id 0x80 is used when no sensor has been found during the bus scan
// additionaly meaning?
#define NO_SENSOR_ID     0x80
...
struct HOTT_GAM_MSG {
    ...
    int8_t gam_sensor_id;       //#02 GAM sensort id. constat value 0x8d
...
struct HOTT_VARIO_MSG {
    ...
    int8_t text_msg[VARIO_MSG_TEXT_LEN]; //#18 Free ASCII text message
...
/* Electric Air Module (EAM) constants. Graupner #33620 */
...
/* GPS constants. Graupner #33600 */
#define GPS_SENSOR_ID           0x8a
#define GPS_SENSOR_TEXT_ID      0xa0

#define GPS_SENSOR_TYPE_GRAUPNER    0x00
#define GPS_SENSOR_TYPE_GYRO        0x01
#define GPS_SENSOR_TYPE_MIKROKOPTER 0xff
...
/* Air ESC constants. Graupner #337xx */
#define AIRESC_SENSOR_ID        0x8c
#define AIRESC_SENSOR_TEXT_ID   0xc0
