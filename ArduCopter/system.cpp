...
void Copter::init_ardupilot()
{
    ...
    char firmware_buf_hott[50];
    snprintf(firmware_buf_hott, sizeof(firmware_buf_hott), "%s %s", fwver.fw_string, get_frame_string());
    hott_telemetry.init(serial_manager, firmware_buf_hott);
#endif
